...
A javascript music player for the [Pushtape](http://www.pushtape.com) project, including global controls and various config options. A useful script to turn a web page with audio links into a playlist with global controls. No dependencies other than [Soundmanager2](http://www.schillmania.com/projects/soundmanager2).
